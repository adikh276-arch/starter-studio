      ...
      <main className="activity-container-lg relative">
        ...
        >
          <button
            ...
            className="w-full bg-white/80 backdrop-blur-md rounded-3xl p-6 border border-white hover:shadow-xl transition-all duration-300 text-left flex items-center gap-5 shadow-sm group"
          >
            <div className="w-14 h-14 rounded-2xl bg-[#10B981] flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-100">
                ...
                >
                  <div className="flex items-start gap-4 mb-3">
                    <div className="w-10 h-10 rounded-xl bg-[#10B981]/10 flex items-center justify-center flex-shrink-0">
                      <MessageSquare className="text-[#10B981]" size={20} strokeWidth={2.5} />
                    </div>
