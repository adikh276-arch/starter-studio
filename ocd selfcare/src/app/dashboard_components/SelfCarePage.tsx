...
export function SelfCarePage() {
  ...
  const categories = [
    { name: "Meditation", icon: Circle },
    { name: "Sleep", icon: Moon },
    { name: "Music", icon: Music },
    { name: "Practics", icon: Target },
    { name: "Soul", icon: Waves },
    { name: "Soundscapes", icon: Volume2 },
          ...
          <main className="max-w-[1000px] w-full mx-auto px-4 md:px-6 py-4 md:py-10 pt-[72px] md:pt-10">
            ...
            >
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <div className="flex-1">
                  <h1 className="text-xl md:text-2xl text-white">Self-Care Resources</h1>
                </div>
              </div>
              <p className="text-xs md:text-sm leading-relaxed text-slate-300 pl-[108px]">
                Expert tools and guidance for your mental wellness journey
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-base md:text-lg text-white">Featured on Mantra</h2>
            ...
            {/* Category Pills */}
            <motion.div
              className="mb-6 w-[1000px] max-w-full"
              initial={{ opacity: 0, y: 15 }}
              animate={{ opacity: 1, y: 0 }}
                ...
                {categories.map((cat, i) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 bg-[#1a2744] hover:bg-[#1f3060] rounded-xl text-white transition-colors"
                    >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-base md:text-lg text-white">New & Noteworthy</h2>
                <button className="text-xs text-slate-400 hover:text-white transition-colors">
                  See All
                </button>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-base md:text-lg text-white">Browse by Goal</h2>
                <button className="text-xs text-slate-400 hover:text-white transition-colors">
                  See All
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                {browseByGoal.map((item, i) => (
                  ...
                  >
                    ...
                    <h3 className="text-sm text-white mt-2 text-left">{item.title}</h3>
                  </motion.button>
                ))}
              </div>
            </motion.div>
            ...
            >
              <div className="mb-4">
                <h2 className="text-base md:text-lg text-white">Browse by Time</h2>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-base md:text-lg text-white">Featured Collections</h2>
                <button className="text-xs text-slate-400 hover:text-white transition-colors">
                  See All
                </button>
              </div>
