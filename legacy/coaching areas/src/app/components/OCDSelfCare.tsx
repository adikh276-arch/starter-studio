...
const topicCards: TopicCard[] = [
  ...
  { id: "fear-ladder", icon: TrendingUp, label: "Fear Ladder", bgColor: "#F3EEFF", iconColor: "#9D6CFF", url: "https://platform\.mantracare.com/app/fear_ladder" },
...
const selfCareToolCards: TopicCard[] = [
  { id: "log-ocd-moments", icon: Clock, label: "Log OCD Moments", bgColor: "linear-gradient(135deg, #a855f7 0%, #9333ea 100%)", iconColor: "#A855F7", url: "https://platform\.mantracare.com/app/ocd_moments" },
  { id: "ocd-daily-life", icon: Calendar, label: "OCD In Daily Life", bgColor: "linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)", iconColor: "#06B6D4", url: "https://platform\.mantracare.com/app/daily_life" },
  { id: "mood-tracker", icon: Smile, label: "Mood Tracker", bgColor: "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)", iconColor: "#F59E0B", url: "https://platform\.mantracare.com/app/mood_tracker" },
  { id: "gratitude-tracker", icon: Star, label: "Gratitude Tracker", bgColor: "linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)", iconColor: "#FBBF24", url: "https://platform\.mantracare.com/app/gratitude_logs" },
  { id: "vibe-tracker", icon: Sparkles, label: "Vibe Tracker", bgColor: "linear-gradient(135deg, #ec4899 0%, #db2777 100%)", iconColor: "#EC4899", url: "https://platform\.mantracare.com/app/vibe_tracker" },
  { id: "withdrawal-tracker", icon: TrendingUp, label: "Withdrawal Tracker", bgColor: "linear-gradient(135deg, #10b981 0%, #059669 100%)", iconColor: "#10B981", url: "http://platform\.mantracare.com/app/withdrawal_tracker" },
];
