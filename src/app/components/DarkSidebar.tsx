...
export function DarkSidebar() {
  ...
  return (
    <motion.div
      ...
      className="hidden md:flex bg-[#0f1729] border-r border-slate-700/50 flex-col h-screen overflow-y-auto overflow-x-hidden sticky top-0 flex-shrink-0"
    >
      {/* Logo + Hamburger */}
      ...
      <nav className="flex-1 p-2">
        ...
        <NavItem
          ...
          colorClass={isActive("/refer") ? "bg-emerald-900/40 text-emerald-400 font-medium" : "text-emerald-400 hover:bg-emerald-900/40 hover:text-emerald-300"}
        />
