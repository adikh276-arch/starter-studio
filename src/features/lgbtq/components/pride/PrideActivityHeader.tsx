/**
 * Ported from
 * `legacy/LGBTQ+ Selfcare/src/features/pride/components/PrideActivityHeader.tsx`.
 * Replaced the Next-style `window.location.href` exit with a react-router
 * fallback so back goes to the LGBTQ+ hub when no `onBack` is provided.
 */
