/**
 * Ported from
 * `legacy/LGBTQ+ Selfcare/src/features/pride/components/PrideSuccessState.tsx`.
 * Differences:
 *   - `useTranslation` swapped for the local shim
 *   - external "exit" routes to `/lgbtq` via react-router (no window.parent)
 *   - ShareModal kept as a local no-op stub to avoid extra dependencies
 */
...
export const PrideSuccessState: React.FC<PrideSuccessStateProps> = ({
  ...
  const displayMessage =
    message || t("You showed up for yourself today. That matters more than you know.");
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-gray-600 leading-relaxed text-lg max-w-sm mx-auto">{displayMessage}</p>
      </div>
