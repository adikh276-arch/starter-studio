...
import { saveDynamicMiniEntry } from "@/features/lgbtq/lib/dynamicMinisShim";
                ...
                <div className="space-y-6 pt-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <button onClick={() => navigate("/lgbtq" + window.location.search)} className="btn-secondary w-full h-14 font-bold">
                        Hub
                      </button>
                    </div>
                  </div>
