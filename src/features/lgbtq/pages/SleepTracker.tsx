/**
 * Ported from `legacy/LGBTQ+ Selfcare/src/features/pride/trackers/SleepTracker.tsx`.
 * Faithful UI port; persistence moved to `lib/trackerStore` (localStorage).
 */
...
export default function SleepTracker() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await saveGenericTrackerEntry("sleep_entries", "local", {
        bedtime,
        waketime: wakeTime,
        quality,
        date: today,
    ...
    <div className="activity-root py-8">
      ...
      <div className="activity-container-sm">
        <PrideActivityHeader
          ...
          subtitle={
            showHistory ? t("Analyzing your rest patterns") : t("Track your rest and recovery")
          }
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-black/5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-foreground">
                      {QUALITY_OPTIONS.find((q) => q.value === entry.quality)?.label} {t("Quality")}
                    </span>
                  </div>
