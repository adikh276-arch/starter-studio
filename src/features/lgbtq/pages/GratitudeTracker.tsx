/**
 * Ported from `legacy/LGBTQ+ Selfcare/src/features/pride/trackers/GratitudeTracker.tsx`.
...
export default function GratitudeTracker() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await saveGenericTrackerEntry("gratitude_entries", "local", {
        items,
    ...
    <div className="activity-root py-8">
      ...
      <div className="activity-container-sm">
        <PrideActivityHeader
          ...
          subtitle={
            showHistory ? t("A collection of your thankful moments") : t("Plant a seed of thankfulness")
          }
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-lg text-foreground">
                    {t("Feeling")}{" "}
                    {MOODS.find((m) => m.emoji === entry.mood_emoji)?.label || t("Good")}
                  </span>
                </div>
              ...
              >
                <div className="space-y-2">
                  <h2 className="text-xl font-bold text-gray-900">
                    {t("How do you feel after reflecting?")}
                  </h2>
