      ...
      sections={[
        { 
          ...
          content: [
            ...
            { title: t("4. No Budget or Tracking"), description: t('Average person loses 15-20% to untracked spending. 30 days of tracking = eye-opening revelations.') },
            { title: t("5. High-Interest Debt for Wants"), description: t('Personal loan at 15% for a vacation means paying 25% more for an experience. Save first, then spend.') },
            { title: t("6. No Insurance Coverage"), description: t('Major medical bills with no health insurance can lead to financial disaster. Protection is essential.') },
            { title: t("7. Investing Without Understanding"), description: t('Blind tips from friends leads to panic selling and losses. Start with diversified index funds you understand.') },
            { title: t("8. No Financial Goals"), description: t('Saving without purpose = spending it. Goals protect your savings from yourself.') },
            { title: t("9. Impulse Spending"), description: t('Small regular impulse buys wasted monthly add up to massive lost wealth over 20 years with investing.') },
            { title: t("10. Not Reviewing & Adjusting"), description: t('Set budget, never look again. Life changes; your plan must change with it. Monthly 15-min review changes everything.') },
            { title: t("11. Comparing to Others"), description: t('You see their car, not their debt. Their vacation, not their stress. Your race, your pace.') },
            { title: t("12. Delaying Financial Decisions"), description: t('Starting at 25 vs 35: same money, 60% less wealth at retirement. Imperfect action beats perfect inaction.') },
          ] 
        },
      ]}
      actionSteps={[
