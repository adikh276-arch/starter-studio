...
import { storage } from '@/features/financial/lib/storage';
  ...
  return (
    <div className="inner-page">
      <PageHeader 
        ...
        bottomSlot={step === totalQuestions ? <SaveAndFinishButton onSave={handleSave} saved={saved} /> : null}
      />
                    ...
                    return (
                      <div key={cat}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                          <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-secondary)' }}>{t(cat)}</span>
