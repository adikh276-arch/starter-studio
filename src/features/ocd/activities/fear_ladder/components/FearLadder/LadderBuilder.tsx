  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-serif font-semibold text-foreground">{t("build_your_practice_ladder")}</h2>
        <button
        ...
        >
          ...
          {t("see_example_ladder")}</button>
      </div>
      <p className="text-sm text-muted-foreground leading-relaxed">
        {t("arrange_situations_from_least")}<br />
        {t("start_where_willingness_feels")}</p>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-xs text-muted-foreground/60 w-16">{t("anxiety")}</span>
                      <input
                        type="range"
                        min="0"
                        max="100"
