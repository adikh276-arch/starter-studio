...
import { ChevronLeft, Phone, Copy, Check, Globe, Clock, Shield, AlertCircle, ChevronDown, Calendar, ArrowRight } from "lucide-react";
        ...
        <main className="max-w-[1000px] w-full mx-auto px-4 md:px-6 py-4 md:py-8 pt-20 md:pt-8">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="w-10 h-10 bg-[#FEE2E2] rounded-md flex items-center justify-center flex-shrink-0">
                <Phone size={20} className="text-[#EF4444]" strokeWidth={2} />
              </div>
              <div>
          ...
          >
            ...
            <div className="text-center mb-8">
              <div className="w-20 h-20 bg-[#DBEAFE] rounded-full flex items-center justify-center mx-auto mb-4">
                <Phone size={36} className="text-[#2563EB]" strokeWidth={2} />
              </div>
            ...
            >
              ...
              <span className="text-lg">Call Emergency Hotline</span>
            </button>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <p className="text-sm text-[#64748B]">
                Round-the-clock support when you need
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-[#043570] mb-1">Confidential</h3>
              <p className="text-sm text-[#64748B]">
            ...
            >
              ...
              <h3 className="font-semibold text-[#043570] mb-1">Global Support</h3>
              <p className="text-sm text-[#64748B]">
            ...
            >
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm text-[#64748B]">
                    Concerned about a loved one's safety or wellbeing
                  </p>
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm text-[#64748B]">
                    Keep your company name, employee ID, or invite code ready
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm text-[#64748B]">
                    Select your region and call the correct number
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full mt-2 flex-shrink-0"></div>
                ...
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm text-[#64748B]">
                    This is immediate support; the therapist may differ each time
                  </p>
                </li>
              </ul>
            </motion.div>
            ...
            <div className="relative">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-[#043570] mb-2">For ongoing care:</h3>
                  <p className="text-sm text-[#64748B] mb-4">
                    Book scheduled sessions with the same therapist for continuous support and personalized care
                  </p>
                  <button
                  ...
                  >
                    <span className="text-sm font-medium">Book in Experts Section</span>
