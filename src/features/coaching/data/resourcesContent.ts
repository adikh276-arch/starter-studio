...
export const resourcesContent: Record<string, AreaResources> = {
  career: {
    ...
    ebooks: [
      { title: "Career Coaching", author: "Jody Michael Associates", url: "/coaching/career-coaching-ebook-final" },
      { title: "80/20 Rule Personal Excellence", author: "Celestine Chua", url: "/coaching/the-80-20-rule-personal-excellence-ebook" },
      { title: "101 Ways To Be A Better Person", author: "Celestine Chua", url: "/coaching/101-ways-to-be-a-better-person-personal-excellence-ebook" },
      { title: "Worklife Reset", author: "Cindy Atlee & Dana Theus", url: "/coaching/wlreset--excerpt" },
      { title: "Personal Brand Coaching Insights", author: "Dana Theus", url: "/coaching/inpowercoaching-careeradvice-ebook" },
    ],
  },
  ...
  executive: {
    ...
    ebooks: [
      { title: "The Effective Executive", author: "Peter E Drucker & Joseph A. Maciariello", url: "/coaching/drucker-2006-the-effective-executive-the-definitive-guide-to-getting-the-right-things-done" },
      { title: "The Ideal Problem Solver", author: "John D. Bransford & Barry S. Stein", url: "/coaching/idealproblemsolver" },
      { title: "The Only Leadership Book You'll Ever Need", author: "Peter Barron Stark & Jane Flaherty", url: "/coaching/the-only-leadership-book-youll-ever-need--how-to-build-organizations-where-employees-love-to-come-to-work-pdfdrive-" },
      { title: "The Seven Habits of Highly Effective People", author: "Stephen R. Covey", url: "/coaching/ati12052021-1" },
      { title: "Time Management", author: "Brian Tracy", url: "/coaching/time-management" },
    ],
  },
  ...
  wellness: {
    ...
    ebooks: [
      { title: "How to Sleep Like a Baby", author: "Ben Wiseman", url: "/coaching/how-to-sleep-like-a-baby-even-if-you-have-sleep-deprivation" },
      { title: "Seven Steps to a Healthy, Fit, Age Resistant Body", author: "Dr. James Meschino", url: "/coaching/seven-steps-to-a-healthy-fit-age-resistant-body" },
      { title: "A New Therapy for Health and Energy", author: "Richard Clark", url: "/coaching/a-new-therapy-for-health-and-energy" },
      { title: "Nudge", author: "Richard H Thaler & Cass R Sunstein", url: "/coaching/nudge-the-final-edition-2021008635-2021008636-9780143137009-9780525508526" },
      { title: "The Foundation of Good Health", author: "Lois Francis", url: "/coaching/the-foundations-of-good-health" },
    ],
  },
  ...
  leadership: {
    ...
    ebooks: [
      { title: "A Shift In Leadership", author: "John Eckhardt", url: "/coaching/a-shift-in-leadership-joh-eckhardt-compress" },
      { title: "30 Secrets To The Top", author: "Paul Enenche", url: "/coaching/dr-paul-enenche-30-secret-to-the-top" },
      { title: "Leadership Training Manual", author: "International Labour Office", url: "/coaching/wcms-125465" },
      { title: "Leading From Within", author: "David R. Kolzow", url: "/coaching/leading-from-within" },
      { title: "7 Crucial Skills of Leadership", author: "Dennis Haley", url: "/coaching/09--the-7-crucial-skills-of-leadership-author-dennis-haley" },
    ],
  },
  ...
  finance: {
    ...
    ebooks: [
      { title: "Building Wealth for Building The Kingdom", author: "Devin D. Thorpe", url: "/coaching/building-wealth-for-building-the-kingdom--a-financial-planning-guide-for-latter-day-saint-families" },
      { title: "925 Ideas to Help You Save Money", author: "Devin D. Thorpe", url: "/coaching/925-ideas-to-help-you-save-money-get-out-of-debt-and-retire-a-millionaire-so-you-can-leave-your-mark-on-the-world" },
      { title: "Noble Use of Money", author: "Dada Bhagwan", url: "/coaching/noble-use-of-money-007550-std" },
      { title: "Essential Finance", author: "Nigel Gibson", url: "/coaching/essential-finance" },
      { title: "The Art of Money Getting", author: "P.T. Barnum", url: "/coaching/p-t-barnum-art-of-money-getting" },
    ],
  },
  ...
  performance: {
    ...
    ebooks: [
      { title: "The Rules of Work", author: "Richard Templar", url: "/coaching/richard-templar-the-rules-of-work-en" },
      { title: "How Successful People Think", author: "John C. Maxwell", url: "/coaching/how-successful-people-think--libtoon-com-" },
      { title: "Getting Things Done", author: "David Allen", url: "/coaching/getting-things-done-the-art-of-stress-free-productivity" },
      { title: "Give and Take", author: "Adam Grant", url: "/coaching/give-and-take" },
      { title: "13 Things Mentally Strong People Don't Do", author: "Amy Morin", url: "/coaching/13-things-mentally-strong-people-dont-do" },
    ],
  },
  ...
  mindset: {
    ...
    ebooks: [
      { title: "Master Your Mind", author: "Anonymous", url: "/coaching/master-your-mind" },
      { title: "How Successful People Think", author: "John C. Maxwell", url: "/coaching/how-successful-people-think--libtoon-com-" },
      { title: "Mindset: The New Psychology of Success", author: "Carol S. Dweck", url: "/coaching/mindset-the-new-psychology-of-success-dweck" },
      { title: "The Millionaire Mindset", author: "Gerry Robert", url: "/coaching/millionaire-mindset" },
      { title: "Think and Grow Rich", author: "Napoleon Hill", url: "/coaching/think-and-grow-rich-2011-06" },
    ],
  },
  ...
  spiritual: {
    ...
    ebooks: [
      { title: "The Hidden Meaning of Truth and Untruth", author: "Dr. Niruben Amin", url: "/coaching/the-hidden-meaning-of-truth-and-untruth" },
      { title: "Death: Before, During, and After…", author: "Dada Bhagwan", url: "/coaching/death-before-during-and-after-007542-std" },
      { title: "Whatever Has Happened Is Justice", author: "Dr. Niruben Amin", url: "/coaching/whatever-happens-justice" },
      { title: "Self-Realization", author: "Pujyashree Deepakbhai Desai", url: "/coaching/self-realization" },
      { title: "Who Am I?", author: "Dr. Niruben Amin", url: "/coaching/who-am-i" },
    ],
  },
  ...
  "mental-health": {
    ...
    ebooks: [
      { title: "The Seven Habits Of Highly Effective People", author: "Stephen R. Covey", url: "/coaching/ati12052021-1" },
      { title: "I Am Not Sick. I Don't Need Help!", author: "Xavier Amador", url: "/coaching/i-am-not-sick-excerpt" },
      { title: "I'm OK-You're OK", author: "Thomas A. Harris MD", url: "/coaching/im-ok-youre-ok" },
      { title: "The Little Book of Mental Health", author: "Anonymous", url: "/coaching/the-little-book-of-mental-health---version-6" },
      { title: "Master Your Mind", author: "Anonymous", url: "/coaching/master-your-mind" },
    ],
  },
  ...
  transform: {
    ...
    ebooks: [
      { title: "Great Habits to Transform Your Life", author: "Michael Chapman", url: "/coaching/50-positive-habits-transform-your-life-by-michael-chapman" },
      { title: "The Great Transformation", author: "Karl Polanyi", url: "/coaching/great-transformation" },
      { title: "The Five Major Pieces To The Life Puzzle", author: "E. James Rohn", url: "/coaching/jim-rohn-ebook-five-major-pieces" },
      { title: "The 5 Second Rule", author: "Mel Robbins", url: "/coaching/the-5-second-rule" },
      { title: "The Little Book of Conflict Transformation", author: "John Paul Lederach", url: "/coaching/the-little-book-of-conflict-transformation" },
    ],
  },
  ...
  communicate: {
    ...
    ebooks: [
      { title: "The Science of Effective Communication", author: "Ian Tuhovsky", url: "/coaching/the-science-of-effective-communication" },
      { title: "The Art of Communicating", author: "Thich Nhat Hanh", url: "/coaching/thich-nhat-hanh" },
      { title: "21 Days of Effective Communication", author: "Ian Tuhovsky", url: "/coaching/21-days-of-effective-communication" },
      { title: "The Communication Book", author: "Mikael Krogerus & Roman Tschäppeler", url: "/coaching/the-communication-book-44-ideas-for-better-conversations-every-day-9781324001997-1324001992-compress" },
      { title: "Improve your Communication Skills", author: "Alan Barker", url: "/coaching/b102--ict-and-communication-skills--improve-your-communication-skillsalan-barkerbookfi" },
    ],
  },
  ...
  organization: {
    ...
    ebooks: [
      { title: "Essentials Of Corporate Communication", author: "Cees B.M. van Riel & Charles J. Fombrun", url: "/coaching/essentials-of-corporate-communication-pdfdrive-com-" },
      { title: "The Psychology Of Motivation To Living A Successful Life", author: "Richard Brown", url: "/coaching/659fbce6a082c-the-psychology-of-motivation" },
      { title: "Time Management", author: "Brian Tracy", url: "/coaching/time-management" },
      { title: "Fostering Creativity & Innovation", author: "Dr. Rashid Alleem", url: "/coaching/fostering-creativity-and-innovation" },
      { title: "Concept of the Corporation", author: "Peter F. Drucker", url: "/coaching/concept-of-the-corporation-pdfdrive-com-" },
    ],
  },
  ...
  creativity: {
    ...
    ebooks: [
      { title: "Scaling Creativity and Innovation", author: "Anonymous", url: "/coaching/scaling-creativity-and-innovation" },
      { title: "The Creative Act", author: "Rick Rubin", url: "/coaching/the-creative-act-by-rick-rubin" },
      { title: "The Power Of Creativity", author: "Bryan Collins", url: "/coaching/3--the-power-of-creativity-book-1--learning-how-to-build-lasting-habits-face-your-fears-and-change-your-life-pdfdrive-" },
      { title: "The Ideal Problem Solver", author: "John D. Bransford & Barry S. Stein", url: "/coaching/idealproblemsolver" },
    ],
  },
  ...
  employee: {
    ...
    ebooks: [
      { title: "Think & Grow Rich", author: "Napoleon Hill", url: "/coaching/think-and-grow-rich-2011-06" },
      { title: "Shape Up", author: "Ryan Singer", url: "/coaching/shape-up" },
      { title: "Work Smarter Not Harder", author: "Timo Kiander", url: "/coaching/work-smarter-not-harder" },
      { title: "The Only Leadership Book You'll Ever Need", author: "Peter Barron Stark & Jane Flaherty", url: "/coaching/the-only-leadership-book-youll-ever-need--how-to-build-organizations-where-employees-love-to-come-to-work-pdfdrive-" },
      { title: "The Big Book Of Team Culture", author: "Activ Collab", url: "/coaching/thebigbookofteamculture" },
    ],
  },
  ...
  corporate: {
    ...
    ebooks: [
      { title: "Growth", author: "Activ", url: "/coaching/growth" },
      { title: "The Fearless Organization", author: "Amy C. Edmondson", url: "/coaching/the-fearless-organization--creating-psychological-safety-in-the-workplace-for-learning-innovation-and-growth" },
      { title: "The Future of Jobs", author: "World Economic Forum", url: "/coaching/wef-future-of-jobs-2023" },
      { title: "The Essentials Of Leadership In Government", author: "Darryl Plecas, Colette Squires & Len Garis", url: "/coaching/essentials-of-leadership-in-govt-2018-2" },
      { title: "Principles of Management", author: "Openstax", url: "/coaching/principlesofmanagement-op-mgbmvou-compressed" },
    ],
  },
  ...
  confidence: {
    ...
    ebooks: [
      { title: "Unshakeable Self-Confidence", author: "Unknown", url: "/coaching/self-confidence-wdb" },
      { title: "Self-Esteem", author: "Matthew Mckay & Patrick Fanning", url: "/coaching/self-esteem---a-proven-program-of-cognitive-techniques-for-assessing-improving-and-maintaining-your-self-esteem-3rd-edition" },
      { title: "The Power of Self-Confidence", author: "Brian Tracy", url: "/coaching/the-power-of-self-confidence-by-brain-tracy-pdf-free-download" },
      { title: "The Power of Self-Esteem", author: "Nathaniel Branden", url: "/coaching/the-power-of-self-esteem" },
      { title: "How to Develop Self-Confidence & Influence People", author: "Dale Carnegie", url: "/coaching/dale-carnegie-how-to-develop-self-confidence-and-influence-people" },
    ],
  },
};
