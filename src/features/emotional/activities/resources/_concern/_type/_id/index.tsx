...
function ResourceDetailInner({ concern, type, id }: ResourceDetailInnerProps) {
    ...
    return (
      <PremiumLayout title={t("app_title", "Resources")}>
        <div className="flex flex-col items-center justify-center py-32 gap-6">
          ...
          <button 
            onClick={() => navigate(`/emotional/resources/${concern}/${type}?lang=${i18n.language}`)} 
  ...
  return (
    <PremiumLayout 
      ...
      onBack={() => navigate(`/emotional/resources/${concern}/${type}?lang=${i18n.language}`)}
    >
...
export default function ResourceDetailPage() {
  const { concern, type, id } = useParams();
