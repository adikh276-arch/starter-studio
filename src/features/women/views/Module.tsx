"use client";
import { useParams, Link, Navigate, useNavigate } from "@/features/women/lib/router";
...
import { modules, type ModuleSlug, TRACKERS } from "@/features/women/data/modules";
import { iconMap } from "@/features/women/lib/icons";
import { toneBg, toneFg, understandingTile } from "@/features/women/lib/tones";
...
const Module = () => {
  ...
  const { t, i18n } = useTranslation([slug as string, 'core']); // Namespace for the module and core for general UI
