        ...
        <main className="max-w-[1000px] w-full mx-auto px-4 md:px-6 py-4 md:py-8 pt-20 md:pt-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <h3 className="font-semibold text-[#0B2545] mb-1">Confidential</h3>
              <p className="text-sm text-[#64748B]">
            ...
            >
              ...
              <h3 className="font-semibold text-[#0B2545] mb-1">Global Support</h3>
              <p className="text-sm text-[#64748B]">
            ...
            <div className="relative">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-[#0B2545] mb-2">For ongoing care:</h3>
