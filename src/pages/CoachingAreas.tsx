...
const toolCards: TopicCard[] = [
  { id: "grow", icon: Bot, label: "GROW", bgColor: "linear-gradient(135deg, #a855f7 0%, #7c3aed 100%)", iconColor: "#AB47BC", route: "/coaching/grow" },
  { id: "life-guidance", icon: Compass, label: "Life Guidance", bgColor: "linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)", iconColor: "#00BCD4", route: "/coaching/compass" },
  { id: "self-awareness", icon: Brain, label: "Self-Awareness", bgColor: "linear-gradient(135deg, #f472b6 0%, #ec4899 100%)", iconColor: "#EC407A", route: "/coaching/self-awareness" },
  { id: "stress-wellbeing", icon: HeartPulse, label: "Stress & Wellbeing", bgColor: "linear-gradient(135deg, #10b981 0%, #059669 100%)", iconColor: "#66BB6A", route: "/coaching/stress-wellbeing" },
  { id: "control-motivation", icon: Gauge, label: "Control & Motivation", bgColor: "linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)", iconColor: "#F9A825", route: "/coaching/control-motivation" },
  { id: "professional-growth", icon: Growth, label: "Professional Growth", bgColor: "linear-gradient(135deg, #fb923c 0%, #f97316 100%)", iconColor: "#FF9800", route: "/coaching/professional-growth" },
];
